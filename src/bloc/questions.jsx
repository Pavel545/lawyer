      ...
      <div className="questions_box">
        <div onClick={() => setActive(1)}  className={
          ...
          <div className="questions_item_head">
            <p>Почему такая стоимость услуг?</p>
            <div
          ...
          >
            <p>
             Мы не занимаемся демпингом. Качественная оценка требует содержания в штате минимум 2-х экспертов с квалификационными аттестатами и страховкой. Дешевая оценка от «агрегаторов» часто ведет к отказу в банке или суде. Мы гарантируем качество.
            </p>
          </div>
        </div>
