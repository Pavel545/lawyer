...
$config['smtp_username'] = 'itmaster@itmastak.ru'; //Смените на имя своего почтового ящика. (ваш email)
...
$config['smtp_password'] = 'asterix250711wsx'; //Измените пароль (от вашего ящика)
